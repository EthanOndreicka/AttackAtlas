              ...
              <div className="bg-slate-900/50 p-6 rounded-xl border border-slate-800">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    <div className="w-2 h-2 mt-2 rounded-full bg-green-500 mr-3 shrink-0" />
                    <div>
                      <span className="font-bold block text-slate-200">Principle of Least Privilege</span>
                      <span className="text-slate-400 text-sm">Restrict database user permissions so an attacker can't access or drop entire tables.</span>
                    </div>
                  </div>
                </div>
              </div>
