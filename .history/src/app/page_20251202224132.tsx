...
import { Shield, Users, Server, Lock, Database, Code, KeyRound, FileWarning, Keyboard, Repeat, Send, Wifi, Route } from 'lucide-react';
    ...
    <main className="min-h-screen bg-slate-950 text-white selection:bg-cyan-500 selection:text-cyan-900 relative">
      <div className="container mx-auto px-4 py-20 relative z-10">
        ...
        >
          ...
          <h1 className="text-6xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-purple-500 text-transparent bg-clip-text relative z-10">
            Attack Atlas
          </h1>
